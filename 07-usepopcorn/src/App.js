...
function MovieDetails({
  ...
  useEffect(
    function () {
      function handleEscCallback(e) {
        if (e.code === 'Escape') {
          onCloseMovie();
        }
      }
      document.addEventListener('keydown', handleEscCallback);
      return function () {
        document.removeEventListener('keydown', handleEscCallback);
      };
    },
    [onCloseMovie]
  );
